...
This document records the repository's working model for Pi and Oh My Pi (OMP) capabilities. It is a stable mental model for designing personal skills, absorbing third-party skills, writing OMP extensions, adding custom tools, and deciding when MCP is warranted.
