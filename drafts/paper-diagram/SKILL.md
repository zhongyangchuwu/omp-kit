...
```bash
python3 drafts/paper-diagram/scripts/svg_export.py figure.svg
```
...
```python
import sys
sys.path.insert(0, "drafts/paper-diagram/scripts")
...
```bash
python3 drafts/paper-diagram/scripts/pptx_export.py figure.pptx
```
